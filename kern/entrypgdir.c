...
// starting at virtual address KERNTOP (that is, it maps virtual
// addresses [KERNTOP, KERNTOP+4MB) to physical addresses [0, 4MB)).
...
pde_t entry_pgdir[NPDENTRIES] = {
	...
	[0]
		= ((uintptr_t)&(entry_pgtable0[0]) - KERNTOP) + PTE_P,
	// Map VA's [KERNTOP, KERNTOP+4MB) to PA's [0, 4MB)
	[KERNTOP>>PDXSHIFT]
		= ((uintptr_t)entry_pgtable0 - KERNTOP) + PTE_P + PTE_W,
	[(KERNTOP>>PDXSHIFT) + 1]
		= ((uintptr_t)entry_pgtable1 - KERNTOP) + PTE_P + PTE_W,
};
